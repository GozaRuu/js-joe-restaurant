...
class Main extends Component {
    ...
    render() {
        const HomeComponentCreator = () => {
            ...
            const promo = this.props.promotions.promotions.filter((promotion) => promotion.featured)[0];
            const leader = this.props.leaders.leaders.filter((leader) => leader.featured)[0];
            return (
                <Home dish={dish} dishLoading={this.props.dishes.isLoading} dishErrMess={this.props.dishes.errMess}
                    promo={promo} promoLoading={this.props.promotions.isLoading} promoErrMess={this.props.promotions.errMess}
                    leader={leader} leaderLoading={this.props.leaders.isLoading} leaderErrMess={this.props.leaders.errMess}
                />
            );
        };
        ...
        const SelectedDishCreator = ({match}) => {
            ...
            return (
                <Dishdetail dish={dish} isLoading={this.props.dishes.isLoading} errMess={this.props.dishes.errMess}
                     comments={comments} commentsErrMess={this.props.comments.errMess} addComment={this.props.addComment}
                 />
            );
        };
