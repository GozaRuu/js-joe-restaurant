      ...
      <div className="container">
        ...
        <div className="row row-content">
          ...
          <div className="col-12 col-sm-4 offset-sm-1">
            <h5>Our Address</h5>
            <address>
              4.5, Clear Water Bay Road
              <br />
              Clear Water Bay, Sfax, Tunisia
              <br />
              <i className="fa fa-phone fa-lg" />: +852 1234 5678
              <br />
              <i className="fa fa-envelope fa-lg" />:{" "}
              <a href="mailto:joe@jsjoe.net">joe@jsjoe.net</a>
            </address>
          </div>
                ...
                <Col md={10}>
                  ...
                  <Errors
                    ...
                    messages={{
                      ...
                      minLength:
                        "The length must be between 3 and 15 character ",
                      maxLength:
                        "The length must be between 3 and 15 character "
                    }}
                  />
                ...
                <Col md={10}>
                  ...
                  <Errors
                    ...
                    messages={{
                      required: "Required Field ",
                      minLength:
                        "The length must be between 6 and 15 character ",
                      maxLength:
                        "The length must be between 2 and 15 character ",
